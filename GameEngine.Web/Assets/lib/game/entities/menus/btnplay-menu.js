...
ig.module('game.entities.menus.btnplay-menu')
.requires(
    //Other required class
    'game.app.entity'
)
.defines(function () {
    EntityBtnplayMenu = Entity.extend({
        name:'BtnplayMenu',
        size:{x:126,y:128},
        animSheet: new ig.AnimationSheet('media/graphics/sprites/button_play.png',126,128),
