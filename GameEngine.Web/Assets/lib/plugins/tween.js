...
ig.Tween = function(obj, properties, duration, settings) {
	...
	this.propUpdate = function(prop, obj, start, delta, value) {
		if(typeof(this.onUpdate) == 'function'){ 
			var modify = this.onUpdate(prop, obj, start, delta, value);
				if(modify && modify.pause) this.pause();
				prop = (modify && modify.prop) ? modify.prop : prop;
				obj = (modify && modify.obj) ? modify.obj : obj;
				start = (modify && modify.start) ? modify.start : start;
				delta = (modify && modify.delta) ? modify.delta : delta;
				value = (modify && modify.value) ? modify.value : value;
		}
